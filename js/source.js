...
var expEntries = [
  {
    company:    'Awesome Coffeehouse',
    role:       'Owner / Manager',
    dates:      '2005 - current',
    writeup:  'Own and operate my own business managing an average of 7 employees.'
  },
  {
    company:    'ABC Accounting',
    role:       'Staff Accountant',
    dates:      '2007 - 2008',
    writeup:  'Worked as a staff accountant/bookkeeper for a full service accounting firm helping small business clients with their bookkeeping needs.'
  },
  {
    company:    'Environmental & Engineering Consultants',
...
// BELOW NOT CURRENTLY IN USE WHILE USING JSON/JQUERY/AJAX TO RETRIEVE SAME DATA FROM PROJECTS.JSON FILE (SAVING AS MAY REFACTOR THE LOCAL STORAGE PIECE AND WILL NEED THIS DATA)
// var projEntries = [
//   {
